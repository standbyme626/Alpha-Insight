...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate Telegram Phase C run report")
    parser.add_argument("--db-path", default="storage/telegram_gateway.db")
    parser.add_argument("--output", default="docs/evidence/telegram_phase_c_run_report.json")
